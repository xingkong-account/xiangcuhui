...
import com.project.bean.Member;
import com.project.bean.PageResult;
import com.project.dto.ResetPasswordRequestDTO;
import com.project.service.MembersService;
...
public class MembersController{
    ...
    public ResponseEntity<String> register(@RequestBody Member member) {
        ...
        List<Member> memberList = memberService.getMembersByEmail(member.getEmail());
        ...
        try {
            ...
            return ResponseEntity.badRequest().body("出错了，请稍后再试");
        }
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("注册失败，未知错误");
    }
