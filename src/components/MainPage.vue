        ...
        <div class="desktop-layout" v-show="!isMobile">
            ...
            <el-container class="total">
                ...
                <el-main>
                    ...
                    <!--                    </div>-->
                    <div class="computer-banner">
                        <el-carousel height="480px" :interval="2000" arrow="always" indicator-position="outside">
...
<!--                                </el-col>-->
                                ...
                                <el-col>
                                    <div class="announcement-title">
                                        ...
                                        <el-button
                                            type="text"
                                            style="color: rgb(87,157,123)"
                                            @click="navigateToArticles">更多>>
                                        </el-button>
                                    </div>
                                    <div class="announcement-list">
                                        <div v-for="(article, index) in articleTitles" :key="index" class="announcement-item">
                                            <router-link :to="'/articles/' + article.id" class="announcement-link">
                                                <span>{{ article.category }}  <span>{{'作者：' + article.author }}</span> - {{ getSnippet(article.title, 25) }}</span>
